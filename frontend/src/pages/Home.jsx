    ...
    <div className="min-h-screen">
      {query ? (
        ...
        <div className="flex flex-col">
          ...
          <section 
            className="w-full relative bg-[#0f172a] pt-20 pb-0 overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8 pb-32">
              <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight drop-shadow-lg mb-6 leading-tight">
                Master Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300">Studies</span>
              </h1>
              <p className="text-xl md:text-2xl text-gray-100 max-w-2xl mx-auto font-medium leading-relaxed drop-shadow-md">
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10">
              <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" className="relative block w-[calc(100%+1.3px)] h-[100px] text-gray-50 fill-current">
            ...
            <section>
              <div className="flex justify-between items-center mb-8 px-2">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Top Rated Notes</h2>
                </div>
                <button className="flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 transition-colors group text-sm py-2 px-4 rounded-full bg-blue-50 hover:bg-blue-100">
            ...
            <section>
              <div className="flex justify-between items-center mb-8 px-2">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Learning Roadmaps</h2>
                </div>
                <button className="flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 transition-colors group text-sm py-2 px-4 rounded-full bg-blue-50 hover:bg-blue-100">
                  View All <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </button>
            ...
            <section>
              <div className="flex justify-between items-center mb-8 px-2">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Recent Questions</h2>
                </div>
                <button className="flex items-center gap-2 text-blue-600 font-bold hover:text-blue-700 transition-colors group text-sm py-2 px-4 rounded-full bg-blue-50 hover:bg-blue-100">
                  View All <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                </button>
